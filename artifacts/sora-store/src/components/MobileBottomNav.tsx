      ...
      <div className="flex items-center justify-between px-2 h-16">
        ...
        <Link href="/wishlist" className="flex flex-col items-center justify-center w-1/5 h-full gap-1 text-muted-foreground hover:text-foreground transition-colors relative">
          <div className="relative">
            ...
            {wishlistCount > 0 && (
              <span className="absolute -top-1 -right-1.5 w-3.5 h-3.5 bg-secondary text-white text-[8px] font-bold rounded-full flex items-center justify-center">{wishlistCount}</span>
            )}
          </div>
          <span className="text-[10px] font-medium">المفضلة</span>
        </Link>
        <Link href="/contact" className="flex flex-col items-center justify-center w-1/5 h-full gap-1 text-muted-foreground hover:text-foreground transition-colors">
